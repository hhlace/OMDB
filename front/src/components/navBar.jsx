...
export default function PrimarySearchAppBar({ handleChange, value, handleSubmit, username, handleLogout }) {
...
/* funciton xfsd ({ handleChange, value, handleSubmit, username, handleLogout }) => (
  <div>
